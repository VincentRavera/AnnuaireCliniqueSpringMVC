                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> <spring:message code="edit-client.title" />
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="table-responsive">
                                        <form:form action="add.html" commandName="client" method="POST">
                                                <form:hidden path="id" />
                                                <form:label path="nom"><spring:message code="list-clients.lastname" /></form:label>
                                                <form:input path="nom" id="nom" />
                                                <form:errors path="nom" class="error"></form:errors>
                                                <br>
                                                <form:label path="prenom"><spring:message code="list-clients.firstname" /></form:label>
                                                <form:input path="prenom" id="prenom" />
                                                <form:errors path="prenom" class="error"></form:errors>
                                                <br>
                                                <form:label path="numero"><spring:message code="list-clients.phonenumber" /></form:label>
